...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.ChannelOverrideTemplate, c.ChannelPerformance, c.ChannelProbe,
		c.ConsumptionRecord, c.DataStorage, c.Model, c.ModelPricing, c.Project,
		c.Prompt, c.ProviderQuotaStatus, c.RechargeRecord, c.RedemptionCode, c.Request,
		c.RequestExecution, c.Role, c.SensitiveWord, c.System, c.SystemSettings,
...
type (
	hooks struct {
		...
		ChannelOverrideTemplate, ChannelPerformance, ChannelProbe, ConsumptionRecord,
		DataStorage, Model, ModelPricing, Project, Prompt, ProviderQuotaStatus,
		RechargeRecord, RedemptionCode, Request, RequestExecution, Role, SensitiveWord,
		System, SystemSettings, Thread, Trace, UsageLog, User, UserProject,
		UserRole []ent.Hook
	}
	inters struct {
		APIKey, Channel, ChannelModelPrice, ChannelModelPriceVersion,
